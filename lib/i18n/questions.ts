...
export const questionTranslationsEn: Record<string, QTrans> = {
  ...
  B11: { text: 'Physical activity — hours per week (sport, walks, workouts)' },
  ...
  B18: { text: 'How many months of expenses are covered by your savings? (emergency fund)', hint: 'Put 0 if no savings. 3 = you can live 3 months without income.' },
  ...
  E03: { text: 'How many times per week do you cook at home?' },
  E04: { text: 'Total screen time per day (phone + computer)' },
  E05: { text: 'Of that — time spent on social media' },
