...
export const questionTranslationsEn: Record<string, QTrans> = {
  ...
  B16: { text: 'Monthly income (after taxes, in USD)', hint: 'Put 0 if no income', unit: '$' },
  B17: { text: 'Monthly expenses (in USD)', hint: 'Approximate amount you spend on living per month', unit: '$' },
